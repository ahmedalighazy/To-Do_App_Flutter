...
class _RegisterPageState extends State<RegisterPage> {
  TextEditingController usernameController =TextEditingController(text: 'ahmedali');

  TextEditingController emailController =TextEditingController(text: 'ahmedali15@gmail.com');
